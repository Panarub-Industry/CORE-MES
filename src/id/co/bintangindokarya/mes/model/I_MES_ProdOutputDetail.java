...
/** Generated Interface for MES_ProdOutputDetail
 *  @author iDempiere (generated) 
 *  @version Release 12
 */
@SuppressWarnings("all")
public interface I_MES_ProdOutputDetail 
{

    /** TableName=MES_ProdOutputDetail */
    public static final String Table_Name = "MES_ProdOutputDetail";
    ...
    /** Column name MES_ProdOutputDetail_ID */
    public static final String COLUMNNAME_MES_ProdOutputDetail_ID = "MES_ProdOutputDetail_ID";
    ...
    /** Column name MES_ProdOutputDetail_UU */
    public static final String COLUMNNAME_MES_ProdOutputDetail_UU = "MES_ProdOutputDetail_UU";
    ...
    /** Column name PostConfirmationNo */
    public static final String COLUMNNAME_PostConfirmationNo = "PostConfirmationNo";
    ...
    public static final String COLUMNNAME_PostDate = "PostDate";
    ...
    public static final String COLUMNNAME_PostMessage = "PostMessage";
    ...
    /** Column name PostNo */
    public static final String COLUMNNAME_PostNo = "PostNo";
    ...
    public static final String COLUMNNAME_PostStatus = "PostStatus";
